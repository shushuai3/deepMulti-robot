...
# MODEL_LIB_SQ8 += ${TILER_GENERATOR_PATH}/BilinearResizes/ResizeBasicKernels.c # same
MODEL_LIB_INCLUDE_SQ8 = -I$(TILER_CNN_KERNEL_PATH) -I$(TILER_CNN_KERNEL_PATH_SQ8) -I$(NNTOOL_KERNEL_PATH) -I$(TILER_BILINEAR_RESIZE_GENERATOR_PATH)# -I$(TILER_BILINEAR_RESIZE_KERNEL_PATH)  # added for bilin res support
...
MODEL_GEN_SQ8 += ${TILER_GENERATOR_PATH}/BilinearResizes/ResizeGenerator.c # same
MODEL_GEN_SQ8 += $(TILER_LIB)
# MODEL_GEN_SQ8 += ${TILER_GENERATOR_PATH}/BilinearResizes/ResizeBasicKernels.c # same
MODEL_GEN_INCLUDE_SQ8 = -I$(TILER_CNN_GENERATOR_PATH) -I$(TILER_CNN_GENERATOR_PATH_SQ8) -I$(NNTOOL_GENERATOR_PATH)# -I$(TILER_BILINEAR_RESIZE_GENERATOR_PATH) -I$(TILER_BILINEAR_RESIZE_KERNEL_PATH)


MODEL_SIZE_CFLAGS = -DAT_INPUT_HEIGHT=$(AT_INPUT_HEIGHT) -DAT_INPUT_WIDTH=$(AT_INPUT_WIDTH) -DAT_INPUT_COLORS=$(AT_INPUT_COLORS) -DAT_OUTPUT_HEIGHT=$(AT_OUTPUT_HEIGHT) -DAT_OUTPUT_WIDTH=$(AT_OUTPUT_WIDTH) -DAT_OUTPUT_COLORS=$(AT_OUTPUT_COLORS)
